...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <identifier>mtype635</identifier>
...
make udp-server.cooja TARGET=cooja DEFINES=SINK=1,BF_TS_NUM=1,SDN_CONF_DATA_SLOTFRAME_SIZE=1506,SDN_CONF_SF_REP_PERIOD=251,SDN_CONF_CONTROL_SLOTFRAME_SIZE=60,SDN_CONF_SIMULATION_RX_SUCCESS=0.0,TX_RANGE=100.0,SDN_CONF_SHARED_CONTROL_PLANE=0,SDN_CONF_SHARED_FROM_CTRL_FLOW=0,SDN_CONF_UNCONTROLLED_EB_SENDING=0,NETWORK_SIZE=10,NETWORK_RADIUS=18</commands>
    ...
    <motetype>
      org.contikios.cooja.contikimote.ContikiMoteType
      <identifier>mtype706</identifier>
...
make udp-client3.cooja TARGET=cooja DEFINES=SINK=0,APP_INT=5020,BF_TS_NUM=1,SDN_CONF_DATA_SLOTFRAME_SIZE=1506,SDN_CONF_SF_REP_PERIOD=251,SDN_CONF_CONTROL_SLOTFRAME_SIZE=60,SDN_CONF_SIMULATION_RX_SUCCESS=0.0,TX_RANGE=100.0,SDN_CONF_SHARED_CONTROL_PLANE=0,SDN_CONF_SHARED_FROM_CTRL_FLOW=0,SDN_CONF_UNCONTROLLED_EB_SENDING=0,NETWORK_SIZE=10,NETWORK_RADIUS=18</commands>
    ...
    <mote>
      ...
      <motetype_identifier>mtype635</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
      ...
      <motetype_identifier>mtype706</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
