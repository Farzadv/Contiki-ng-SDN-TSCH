...
make udp-server.cooja TARGET=cooja DEFINES=SINK=1,BF_TS_NUM=1,SDN_CONF_DATA_SLOTFRAME_SIZE=1506,SDN_CONF_SF_REP_PERIOD=251,SDN_CONF_CONTROL_SLOTFRAME_SIZE=30,SDN_CONF_SIMULATION_RX_SUCCESS=0.71,TX_RANGE=50.0,NETWORK_SIZE=3</commands>
    ...
    <motetype>
      ...
      <commands>make clean TARGET=cooja
make udp-client3.cooja TARGET=cooja DEFINES=SINK=0,APP_INT=2510,BF_TS_NUM=1,SDN_CONF_DATA_SLOTFRAME_SIZE=1506,SDN_CONF_SF_REP_PERIOD=251,SDN_CONF_CONTROL_SLOTFRAME_SIZE=30,SDN_CONF_SIMULATION_RX_SUCCESS=0.71,TX_RANGE=50.0,NETWORK_SIZE=3</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>0.15428653554325322</x>
        <y>8.624505938320755</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-2.9676191973991273</x>
        <y>-1.7770363953733828</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
