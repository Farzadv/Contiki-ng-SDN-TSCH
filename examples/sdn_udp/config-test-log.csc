...
make udp-server.cooja TARGET=cooja DEFINES=SINK=1,BF_TS_NUM=15,SDN_CONF_DATA_SLOTFRAME_SIZE=3001,SDN_CONF_SF_REP_PERIOD=199,SDN_CONF_CONTROL_SLOTFRAME_SIZE=60</commands>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/sdn_udp/udp-client.c</source>
      <commands>make clean TARGET=cooja
make udp-client.cooja TARGET=cooja DEFINES=SINK=0,APP_INT=30,BF_TS_NUM=15,SDN_CONF_DATA_SLOTFRAME_SIZE=3001,SDN_CONF_SF_REP_PERIOD=199,SDN_CONF_CONTROL_SLOTFRAME_SIZE=60</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <motetype>
      ...
      <commands>make clean TARGET=cooja
make udp-client3.cooja TARGET=cooja DEFINES=SINK=0,APP_INT=30,BF_TS_NUM=15,SDN_CONF_DATA_SLOTFRAME_SIZE=3001,SDN_CONF_SF_REP_PERIOD=199,SDN_CONF_CONTROL_SLOTFRAME_SIZE=60</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>42.991034799662884</x>
        <y>-7.8577512595595636</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.5201334520783534 0.0 0.0 1.5201334520783534 203.14843825443958 211.86844699611007</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>468</height>
