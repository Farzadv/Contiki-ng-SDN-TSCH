...
make udp-server.cooja TARGET=cooja DEFINES=SINK=1,BF_TS_NUM=1,SDN_CONF_DATA_SLOTFRAME_SIZE=251,SDN_CONF_SF_REP_PERIOD=251,SDN_CONF_CONTROL_SLOTFRAME_SIZE=30,SDN_CONF_NUM_SHARED_CELL_IN_REP=10,SDN_CONF_SIMULATION_RX_SUCCESS=1.0</commands>
    ...
    <motetype>
      org.contikios.cooja.contikimote.ContikiMoteType
      <identifier>mtype591</identifier>
      <description>Cooja Mote Type #2</description>
      <source>[CONTIKI_DIR]/examples/sdn_udp/udp-client3.c</source>
      <commands>make clean TARGET=cooja
make udp-client3.cooja TARGET=cooja DEFINES=SINK=0,APP_INT=2.51,BF_TS_NUM=1,SDN_CONF_DATA_SLOTFRAME_SIZE=251,SDN_CONF_SF_REP_PERIOD=251,SDN_CONF_CONTROL_SLOTFRAME_SIZE=30,SDN_CONF_NUM_SHARED_CELL_IN_REP=10,SDN_CONF_SIMULATION_RX_SUCCESS=1.0</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>1.79261434205395</x>
        <y>47.25484065546757</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
      ...
      <motetype_identifier>mtype591</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-0.6243202793263622</x>
        <y>4.102173607603486</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
