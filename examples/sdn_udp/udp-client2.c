...
#define TRAFFIC_PERIOD  101 // ts
#define MAX_DELAY       0
#define PACKET_SIZE     0
#define RELIABILITY     97
#define BURST_SIZE      0
...
PROCESS_THREAD(udp_client_process, ev, data)
{
  ...
  uip_ip6addr(&server_ipaddr,  0xfe80, 0, 0, 0, 0, 0xff, 0xfe00, 0x6);
...
{ 
  ...
  while(!find_asn) {
    ...
    if(tsch_current_asn.ls4b > 0x668a0) {
        count = 1;
        find_asn = 1;
    }
    etimer_reset(&timer);
