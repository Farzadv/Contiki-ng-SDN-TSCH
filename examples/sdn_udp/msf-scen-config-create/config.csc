...
make udp-server.cooja TARGET=cooja DEFINES=SINK=1,BF_TS_NUM=1,SDN_CONF_DATA_SLOTFRAME_SIZE=251,SDN_CONF_SF_REP_PERIOD=251,SDN_CONF_CONTROL_SLOTFRAME_SIZE=30,SDN_CONF_NUM_SHARED_CELL_IN_REP=4,SDN_CONF_SIMULATION_RX_SUCCESS=0.71,TX_RANGE=50.0</commands>
    ...
    <motetype>
      ...
      <commands>make clean TARGET=cooja
make udp-client3.cooja TARGET=cooja DEFINES=SINK=0,APP_INT=2.51,BF_TS_NUM=1,SDN_CONF_DATA_SLOTFRAME_SIZE=251,SDN_CONF_SF_REP_PERIOD=251,SDN_CONF_CONTROL_SLOTFRAME_SIZE=30,SDN_CONF_NUM_SHARED_CELL_IN_REP=4,SDN_CONF_SIMULATION_RX_SUCCESS=0.71,TX_RANGE=50.0</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
