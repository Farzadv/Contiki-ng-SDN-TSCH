...
static float POS_ARRAY[40][2] = {{0.0, 0.0}, {4.72, 9.85}, {-21.76, -5.72}, {23.01, 15.98}, {-16.59, 15.94}, {-22.32, 15.89}, {-8.76, 17.34}, {-2.21, -22.23}, {-11.74, -24.44}, {19.02, -3.44}, {-12.22, 22.8}, {-6.16, 32.03}, {10.96, 38.34}, {-29.44, 15.27}, {-37.19, -28.46}, {-24.67, 40.21}, {1.99, 43.62}, {15.79, -38.69}, {11.39, -39.1}, {-10.08, -35.17}, {17.11, -34.09}, {-26.23, -43.25}, {-42.37, -31.04}, {-24.85, 52.95}, {4.24, 55.18}, {-32.49, 47.85}, {15.09, 60.27}, {11.87, 62.5}, {33.99, 57.13}, {-54.6, 14.7}, {-46.33, -50.37}, {-59.22, -24.96}, {5.02, -67.85}, {39.05, -41.64}, {-30.45, -61.1}, {-70.64, -4.52}, {55.1, -22.05}, {60.62, -11.87}, {65.58, 10.51}, {58.51, 32.1}};
...
#define MAX_NUM_PENDING_CONFIG   10
          ...
          if(linkaddr_cmp(&e2->nbr_list[w].nbr_addr, &addr1)) {
            ...
            */
            if(e2->nbr_list[w].total_eb_num > 0) {
              ...
              revers_direction_pdr = 0.94 * revers_direction_pdr;
            } else {
